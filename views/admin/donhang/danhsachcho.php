                    ...
                    <tbody>
                        <?php foreach ($data as $key => $value):?>
                          <tr>
                            ...
                            <td><a href="?controller=admin&action=don-hang-moi&param=delete&id=<?=$value['id']?>" class="btn btn-danger">Xoá</a></td>
                            <td><a href="?controller=admin&action=don-hang-moi&param=update&id=<?=$value['id']?>" class="btn btn-success">Chấp nhận</a></td>
                        </tr>
                    <?php endforeach ?>
