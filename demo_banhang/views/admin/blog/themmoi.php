		...
		<div class="row ">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<textarea name="title" class="form-control" rows="5" required=""></textarea>
				</div>
				<div class="form-group">
					<label for="pwd">Ảnh đại diện:</label>
					<input name="img" type="file" class="form-control-file border" required="">
				</div>
			...
			<div class="col-md-8">
				...
				<div style="text-align: center;" class="mt-3">
					...
					<button type="submit" name="submit" class="btn btn-success ml-3">Thêm mới</button>
				</div>
			</div>
