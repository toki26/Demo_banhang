                    ...
                    <tbody>
                        <?php foreach ($data as $key => $value):?>
                          <tr>
                            ...
                            <td><a href="?controller=admin&action=dang-gui&param=delete&id=<?=$value['id']?>" class="btn btn-danger">Huỷ đơn</a></td>
                            <td><a href="?controller=admin&action=dang-gui&param=update&id=<?=$value['id']?>" class="btn btn-success">Đã nhận </a></td>
                        </tr>
                    <?php endforeach ?>
